...
def main():
    ...
    # 数据集
    train_set = VehicleID_All(root='/home/asus/design_biye/target_detection/rid_data/dataset/VehicleID_V1.0/',
                              transforms=None,
                              mode='train')
    test_set = VehicleID_All(root='/home/asus/design_biye/target_detection/rid_data/dataset/VehicleID_V1.0/',
                             transforms=None,
                             mode='test')
...
# 这个其实不是原版的文件， 感觉最后使用原来提供的这个文件效果会比较好一些
